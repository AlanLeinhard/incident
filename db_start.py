...
#                url_serv="https://192.168.100.150:5601", image=image, click=0, active=True)
...
#                url_serv="http://192.168.100.150:3005", image=image, click=0, active=True)
# db.session.add(service)
# db.session.commit()
# print("done")
...
#                url_serv="http://192.168.100.150:5050", image=image, click=0, active=True)
# db.session.add(service)
# db.session.commit()
# print("done")
...
#                url_serv="http://192.168.100.150:9095", image=image, click=0, active=True)
# db.session.add(service)
# db.session.commit()
# print("done")
...
#                url_serv="https://192.168.100.150:4443", image=image, click=0, active=True)
# db.session.add(service)
# db.session.commit()
# print("done")
...
#                url_serv="https://192.168.100.150:4445", image=image, click=0, active=True)
# db.session.add(service)
# db.session.commit()
# print("done")
...
#                url_serv="https://192.168.100.150:8086", image=image, click=0, active=True)
# db.session.add(service)
# db.session.commit()
# print("done")
...
#                url_serv="http://192.168.100.150:8100", image=image, click=0, active=True)
# db.session.add(service)
# db.session.commit()
# print("done")
...
#                url_serv="http://192.168.100.150:8081", image=image, click=0, active=True)
# db.session.add(service)
# db.session.commit()
# print("done")
...
#                url_serv="http://192.168.100.150:8002", image=image, click=0, active=True)
# db.session.add(service)
# db.session.commit()
# print("done")
...
#                url_serv="http://192.168.100.150:8087", image=image, click=0, active=True)
# db.session.add(service)
# db.session.commit()
# print("done")
...
#                url_serv="http://192.168.100.150:3000", image=image, click=0, active=True)
# db.session.add(service)
# db.session.commit()
# print("done")
